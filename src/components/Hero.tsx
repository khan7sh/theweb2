...
export default function Hero() {
  return (
    <div className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-1/2 h-1/2 bg-[radial-gradient(circle_at_center,_#3b0764,_transparent_50%)]"></div>
      <div className="absolute bottom-0 left-0 w-1/2 h-1/2 bg-[radial-gradient(circle_at_center,_#312e81,_transparent_50%)]"></div>
      <div className="section-shadow-bottom"></div>
      
      <div className="site-container container-padding relative pt-24 pb-12">
        <div className="max-w-4xl lg:max-w-5xl">
          ...
          <p className="text-xl sm:text-2xl text-gray-400 mb-16 leading-relaxed max-w-3xl 
